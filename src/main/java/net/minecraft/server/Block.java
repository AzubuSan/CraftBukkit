...
public class Block {
    ...
    public static final Block WATER = (new BlockFlowing(8, Material.WATER)).c(100.0F).f(3).a("water").p().i();
    public static final Block STATIONARY_WATER = (new BlockStationary(9, Material.WATER)).c(100.0F).f(3).a("water").p().i();
    public static final Block LAVA = (new BlockFlowing(10, Material.LAVA)).c(0.0F).a(1.0F).f(255).a("lava").p().i();
    public static final Block STATIONARY_LAVA = (new BlockStationary(11, Material.LAVA)).c(100.0F).a(1.0F).f(255).a("lava").p().i();
    ...
    public static final Block ENCHANTMENT_TABLE = (new BlockEnchantmentTable(116)).a("enchantmentTable");
    ...
    public static boolean[] bL = new boolean[256];
        ...
        if (!world.isStatic) {
            ...
            for (int k1 = 0; k1 < j1; ++k1) {
                ...
                if (world.random.nextFloat() < f) {
                    ...
                    if (l1 > 0) {
                        this.a(world, i, j, k, new ItemStack(l1, 1, this.a_(l)));
                    }
                }
            }
        }
    ...
    public void a(World world, EntityHuman entityhuman, int i, int j, int k, int l) {
        ...
        if (this.c() && !isTileEntity[this.id] && EnchantmentManager.d(entityhuman.inventory)) {
    ...
    static {
        ...
        Item.byId[WATER_LILY.id] = new ItemColoredBlock(WATER_LILY.id - 256, false);
