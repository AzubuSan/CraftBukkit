...
public abstract class EntityCreature extends EntityLiving {
    ...
    protected void l_() {
        ...
        if (!this.e && this.target != null && (this.pathEntity == null || this.random.nextInt(20) == 0)) {
            this.pathEntity = this.world.findPath(this, this.target, f);
        } else if (!this.e && (this.pathEntity == null && this.random.nextInt(180) == 0 || this.random.nextInt(120) == 0 || this.f > 0) && this.aR < 100) {
            this.C();
        }
        ...
        if (this.pathEntity != null && this.random.nextInt(100) != 0) {
            ...
            if (vec3d != null) {
                ...
                for (this.aT = this.aX; f3 < -180.0F; f3 += 360.0F) {
                    ;
                }
                ...
                if (this.e && this.target != null) {
                    ...
                    this.aS = -MathHelper.sin(f3) * this.aT * 1.0F;
                    this.aT = MathHelper.cos(f3) * this.aT * 1.0F;
                }
