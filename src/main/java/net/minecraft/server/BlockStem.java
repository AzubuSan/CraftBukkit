    ...
    public void a(World world, int i, int j, int k, Random random) {
        ...
        if (world.getLightLevel(i, j + 1, k) >= 9) {
            ...
            if (random.nextInt((int) (25.0F / f) + 1) == 0) {
                ...
                if (l < 7) {
                    org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(world, i, j, k, ++l); // CraftBukkit
                } else {
                    ...
                    if (world.getTypeId(j1, j, k1) == 0 && (l1 == Block.SOIL.id || l1 == Block.DIRT.id || l1 == Block.GRASS.id)) {
                        org.bukkit.craftbukkit.event.CraftEventFactory.handleBlockGrowEvent(world, j1, j, k1, this.a.id); // CraftBukkit
                    }
                }
            }
        }
