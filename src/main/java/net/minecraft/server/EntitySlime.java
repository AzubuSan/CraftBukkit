...
public class EntitySlime extends EntityLiving implements IMonster {
    ...
    protected void l_() {
        ...
        if (this.onGround && this.size-- <= 0) {
            ...
            this.a = 1.0F;
            this.aS = 1.0F - this.random.nextFloat() * 2.0F;
            this.aT = (float) (1 * this.getSize());
        } else {
            this.aV = false;
            if (this.onGround) {
    ...
    public void a_(EntityHuman entityhuman) {
        if (this.C()) {
            ...
            if (this.f(entityhuman) && (double) this.g(entityhuman) < 0.6D * (double) i && entityhuman.damageEntity(DamageSource.mobAttack(this), this.D())) {
    ...
    public boolean g() {
        ...
        return (this.getSize() == 1 || this.world.difficulty > 0) && this.random.nextInt(10) == 0 && chunk.a(987234911L).nextInt(10) == 0 && this.locY < 40.0D;
    }
