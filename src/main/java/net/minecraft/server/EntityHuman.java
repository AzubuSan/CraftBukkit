...
public abstract class EntityHuman extends EntityLiving {
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource != null) {
            this.motX = (double) (-MathHelper.cos((this.as + this.yaw) * 3.1415927F / 180.0F) * 0.1F);
            this.motZ = (double) (-MathHelper.sin((this.as + this.yaw) * 3.1415927F / 180.0F) * 0.1F);
        } else {
    ...
    public void s_() {
        if (!this.s || this.t >= this.A() / 2 || this.t < 0) {
            this.t = -1;
            this.s = true;
        }
    }
    ...
    public void e(Entity entity) {
        ...
        if (i > 0 || k > 0) {
            boolean flag = this.motY < 0.0D && !this.onGround && !this.r() && !this.az() && !this.hasEffect(MobEffectList.BLINDNESS);
