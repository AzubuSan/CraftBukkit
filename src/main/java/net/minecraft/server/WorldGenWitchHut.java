...
public class WorldGenWitchHut extends WorldGenScatteredPiece {
    ...
    public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
        String xyz = structureboundingbox.a + "," + structureboundingbox.b + "," + structureboundingbox.c;
        System.out.println("Processing Witch Hut @" + xyz + " [" + h);
        if (!this.a(world, structureboundingbox, 0)) {
            ...
            if (!this.h) {
                ...
                boolean result = structureboundingbox.b(i1, j1, k1);

                System.out.println("Witch spawned (" + result + "): " + i1 + "," + j1 + "," + "," + k1);
